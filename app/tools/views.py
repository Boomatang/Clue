...
def louver_calculator():
    ...
    if form.validate_on_submit():
        ...
        mesh30 = louver_efficiency(float(width), float(height), .3)
        mesh70 = louver_efficiency(float(width), float(height), .7)
        return render_template('utls/louver-calculator.html', mesh30=mesh30, mesh70=mesh70, form=form)
