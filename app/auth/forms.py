...
class RegistrationForm(FlaskForm):
    ...
    email = StringField(
        "E-mail address", validators=[data_required(), Length(1, 64), Email()]
    )
    ...
    password = PasswordField(
        ...
        validators=[
            ...
            Length(8, message="Password most be " "8 characters long"),
        ],
    )
...
class ChangeEmailForm(FlaskForm):
    email = StringField(
        "New Email", validators=[data_required(), Length(1, 64), Email()]
    )
    password = PasswordField("Password", validators=[data_required()])
